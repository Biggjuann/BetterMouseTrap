...
class Session(Base):
    ...
    selected_variant_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    spec_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    patent_hits_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    patent_draft_json: Mapped[str | None] = mapped_column(Text, nullable=True)
